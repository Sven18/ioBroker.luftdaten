...
gulp.task('rename', function ()  {
    var newname;
    var author = 'Sven Tegtmeyer';
    var email  = 'sven.feuerwehr14@gmail.com';
    ...
    if (!newname) {
        console.log('Please write the new luftdaten name, like: "gulp rename --name mywidgetset" --author "Author Name"');
        process.exit();
    }
    ...
    var patterns = [
        ...
        {
            match: /Sven Tegtmeyer/g,
            replacement: author
        },
        {
            match: /sven.feuerwehr14@gmail.com/g,
            replacement: email
        }
    ];
    var files = [
